...
namespace MoviesFair.Areas.Customer.Controllers
{
    ...
    public class GenresController : Controller
    {
        ...
        // GET: Customer/Genres/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Customer/Genres/Create
